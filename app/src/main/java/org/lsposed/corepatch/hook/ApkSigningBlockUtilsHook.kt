...
object ApkSigningBlockUtilsHook : BaseHook() {
    ...
    override fun hook() {
        ...
        hookBefore(parseVerityDigestAndVerifySourceLengthMethod, object : BeforeCallback {
        ...
        hookBefore(verifyIntegrityForVerityBasedAlgorithmMethod, object : BeforeCallback {
            override fun before(callback: BeforeHookCallback) {
                if (Config.isBypassVerificationEnabled()) {
